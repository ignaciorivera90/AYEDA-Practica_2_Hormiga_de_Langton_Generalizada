 ...
 *
 * Archivo: ant_ddid.h
 * Descripcion: Declaracion de la clase Ant_DDID, hormiga con regla "DDID".
 * Referencias:
...
class Ant_DDID_INV : public Ant {
 public:
  Ant_DDID_INV(int x, int y, Direction dir, const char* ansi_color)
      : Ant("DDIDr", x, y, dir, ansi_color) {}
